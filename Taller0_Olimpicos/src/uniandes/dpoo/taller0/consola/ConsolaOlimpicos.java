...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar el país al cual representa un atleta");
		System.out.println("14. Salir de la aplicación\n");
	}
	
	/**
	 * Le pide al usuario el nombre de un atleta, y luego le muestra el nombre
	 * del país al cual representa el atleta.
	 */
	private void ejecutarPaisAtleta()
	{
		System.out.println("\n" + "País al cual representa un atleta" + "\n");
		
		String nombre_atleta = input("Ingrese el nombre del atleta").toLowerCase();
		
		String resultado = calculadora.paisAtleta(nombre_atleta);
		...
		{
			System.out.println("El país al cual representa " + nombre_atleta + " es: " + resultado);
		}
	}
