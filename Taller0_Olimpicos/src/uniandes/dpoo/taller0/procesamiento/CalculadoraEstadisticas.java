...
public class CalculadoraEstadisticas
{
	...
	/**
	 * Calcula el país al cual representa un atleta.
	 * 
	 * @param nombreAtleta El nombre del atleta
	 * @return Un string con el nombre del país al cual representa el atleta
	 */
	public String paisAtleta(String nombreAtleta)
	{
		Pais pais = null;
		String respuesta = null;
		Atleta hayAtleta = buscarAtleta(nombreAtleta);
		
		if (hayAtleta != null)
		{
			pais = hayAtleta.darPais();
